...
- **Полная блокировка мата** - имена с матом отклоняются (не фильтруются)
- Поддержка транслита (blyat, hui, pizda и т.д.)
...
Сервер проверяет имена на наличие:
- Русского мата (хуй, пизда, ебать, сука и т.д.)
- Английского мата (fuck, shit, dick и т.д.)
- Транслита (blyat, hui, pizda, suka и т.д.)

Если имя содержит мат, пользователь видит ошибку: **"Нельзя использовать мат в имени"**
